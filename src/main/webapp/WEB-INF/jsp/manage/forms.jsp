...
$("#left_nav").find('li').eq(2).addClass("active");
});
</script>
					...
					<footer class="footer">
						<div class="container-fluid">
							...
							<div class="copyright ml-auto">
								2018, made with <i class="la la-heart heart text-danger"></i> by <a href="#">ThemeKita</a> - More Templates <a href="http://www.cssmoban.com/" target="_blank" title="ģ��֮��">ģ��֮��</a> - Collect from <a href="http://www.cssmoban.com/" title="��ҳģ��" target="_blank">��ҳģ��</a></div>				
						</div>
					</footer>
				</div>
</body>
