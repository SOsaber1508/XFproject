...
public class TokenUtil {
	...
	private static String BaiduAccessToken = "RedisBaiduAccessToken";
	/**
	 * 判断token是否过期
	 */
	...
	private static String getAuth(String clientId, String clientSecret) {
		...
		try {
			...
			System.out.println("expires_in.intValue()++++"+expires_in.intValue());
	...
	public static String IDcard() {
		...
		if (needAuth().booleanValue()) {
			//jedisClient.del(BaiduAccessToken); // 删除数据-根据key
			access_token = getAuth();
			//jedisClient.set(BaiduAccessToken, access_token);
			System.out.println("flag:" + flag);
	...
	public void redisDel(String access_token) {
		jedisClient.set(BaiduAccessToken, access_token);
	}
