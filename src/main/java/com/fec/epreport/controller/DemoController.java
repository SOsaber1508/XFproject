...
public class DemoController {
	...
	public String selectallManage(Model model,String excelMsg,@RequestParam(defaultValue="1",required=true,value="pageNo") int pageNo) 
	{
		try {
			//分页插件
			...
			//PageInfo<DownloadManage> pageInfo=new PageInfo<DownloadManage>(downloadManage);
