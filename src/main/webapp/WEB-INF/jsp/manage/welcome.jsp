						...
						<div class="card">
							<div class="card-header">
								...
								<p class="card-category">
									请选择要查询的年份： <select id="year" class="form-control col-md-6">
							...
							<div id="main" class="col-xs-12"
								style="width: 90%; height: 50%; left: 5%"></div>
							<script type="text/javascript">
										var myChart;
				...
				<div class="row">
					<div class="col-md-4">
						<div class="card">
							<div class="card-header">
								...
								<p class="card-category">Users statistics this month</p>
							</div>
							<div class="card-body">
					...
					<div class="col-md-8">
						<div class="card">
							<div class="card-header">
								...
								<p class="card-category">Number of products sold</p>
							</div>
							<div class="card-body">
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<table
									class="table table-head-bg-success table-striped table-hover col-md-6">
									<thead>
										<tr>
											<th scope="col">id</th>
											<th scope="col">姓名</th>
								...
								<div align="center" id="fenye">
									<p id="fenye1">
										<span> 当前 ${userlist.pageNum }页,总${userlist.pages }
											页,总${userlist.total } 条记录 <input type="hidden" name="page"
											id="page" />
										</span>
									</p>
									<span id="fenye2"> <a href="javascript:"
										onclick="toPage(1)">第一页</a>
									</span> <span id="fenye3"> <c:if
											test="${userlist.hasPreviousPage }">
											<a href="javascript:" onclick="toPage(${userlist.pageNum-1})">上一页</a>
										</c:if>
									</span> <span id="fenye4"> <c:if test="${userlist.hasNextPage}">
											<a href="javascript:" onclick="toPage(${userlist.pageNum+1})">下一页</a>
										</c:if>
									</span> <span id="fenye5"> <a href="javascript:"
										onclick="toPage(${userlist.pages})">最后页</a>
									</span>
		...
		<div class="container-fluid">
			...
			<ul class="nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="#license/#free-item"> Licenses </a></li>
			</ul>
			</nav>
			<div class="copyright ml-auto">
				2019, made with <i class="la la-heart heart text-danger"></i> by <a
					href="#">奈落落</a> - More Templates - Collect from <a
					href="https://tieba.baidu.com/f?fr=wwwt&kw=%E5%A5%88%E8%90%BD%E8%90%BD"
					title="奈落落" target="_blank">奈落落</a>
			</div>
		</div>
		</footer>
	</div>
